...
function buildVehiclesDisplay($vehicles){
    ...
    foreach ($vehicles as $vehicle) {
     $dv .= '<li>';
     $dv .= "<a href='/phpmotors/vehicles/?action=vehiclepage&invId=".urlencode($vehicle['invId'])."'><img src='$vehicle[imgPath]' alt='Image of $vehicle[invMake] $vehicle[invModel] on phpmotors.com'></a>";
    //  $dv .= '<hr>';
   ...
   function buildVehiclePage($invInfo){
    ...
    $dv .= "<h3>\${$price}</h3>";
    $dv .= "<img src='{$invInfo['imgPath']}' alt='Image of $invInfo[invMake] $invInfo[invModel]'>";
